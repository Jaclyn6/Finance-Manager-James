...
export const metadata: Metadata = {
  ...
  icons: {
    // Browser favicon — PNG primary (universal), SVG declared as
    // alternate so modern browsers can pick the resolution-independent
    // copy. Generated by `scripts/generate-icons.mjs` from the SVG
    // sources in `public/icons/` via `sharp`; re-run after editing
    // any source SVG.
    icon: [
      { url: "/icons/192.png", sizes: "192x192", type: "image/png" },
      { url: "/icons/192.svg", type: "image/svg+xml" },
    ],
    // iOS Safari "Add to Home Screen" historically resolves
    // apple-touch-icon as PNG more reliably than SVG across iOS 14–17;
    // serving 192×192 PNG matches the modern apple-touch-icon
    // recommendation. (Apple requests 180×180 specifically, but iOS
    // accepts any square ≥120px and downscales — a single 192 PNG
    // covers all current devices without bloating the manifest.)
    apple: "/icons/192.png",
  },
};
