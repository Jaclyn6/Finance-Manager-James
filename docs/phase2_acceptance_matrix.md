...
- **MET:** 11 / 16 = 69% (incremented 2026-04-26: §10.1 row 8 "매수 타이밍 시그널 엔진" + §10.3 row 3 "Signal Alignment Card on all 3 protected routes" both promoted from PARTIAL to MET after commit `8261924` wired SignalCard onto `/changelog`).
- **PARTIAL:** 5 / 16 = 31%.
